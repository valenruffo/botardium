...
def _serialize_campaign(campaign: Dict[str, Any]) -> Dict[str, Any]:
    return {
        ...
        "username": campaign.get("username") or "",
        "limit": int(campaign.get("limit") or 10),
        "execution_mode": campaign.get("execution_mode") or "real",
        "filters": campaign.get("filters", {}),
        "filter_profile": campaign.get("filter_profile", "strict"),
        "sources": campaign.get("sources", []),
        "source_stats": campaign.get("source_stats", {}),
        "warmup_mode": campaign.get("warmup_mode", "skip"),
        "warmup_minutes": int(campaign.get("warmup_minutes") or 0),
        "status": campaign.get("status") or "draft",
        "current_action": campaign.get("current_action") or "",
        "progress": int(campaign.get("progress") or 0),
        "created_at": campaign.get("created_at") or 0,
